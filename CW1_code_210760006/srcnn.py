...
iio.imsave('HR_image.jpg',HR_image) #saving the ground truth lf the image
iio.imsave('LR_image.jpg',LR_image) #saving the low resolution or interpolated image
iio.imsave('SR_image.jpg',output_)  #saving high resolution image by SRCNN

b = skimage.metrics.peak_signal_noise_ratio(HR_image,output_)
print("PSNR for HR image wrt SRCNN output",b)
h = skimage.metrics.peak_signal_noise_ratio(HR_image,LR_image) 
print("PSNR for HR image wrt LR image",h)